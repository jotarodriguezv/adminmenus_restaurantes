...
const INSTRUCCIONES = process.env.LECTOR_INSTRUCCIONES || [
  ...
  '   cada una.',
  '7. Cada plato va bajo el título de sección que le corresponde en la carta.',
  '   Deja el nombre de la categoría vacío SOLO si de verdad no hay ningún',
  '   título encima de ese plato.',
  ...
  '9. Un aviso que vale para una sección entera —"todas las hamburguesas van',
  '   acompañadas de papas", "todos los platos incluyen bebida"— NO es un',
  '   plato. Déjalo fuera. Si lo metes como plato, sale en la carta a $0.',
  '10. Ignora las fotografías de los platos por completo. No las describas ni',
